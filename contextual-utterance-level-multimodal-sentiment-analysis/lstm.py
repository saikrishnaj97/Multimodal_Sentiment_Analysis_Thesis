...
def unimodal(mode):
	...
	lstm1 = Bidirectional(LSTM(300, activation='tanh', return_sequences = True, dropout=0.6))(masked)
	inter1 = Dropout(0.9)(lstm1)
	lstm2 = Bidirectional(LSTM(300,activation='tanh', return_sequences= True, dropout=0.6))(inter1)
...
def multimodal(unimodal_activations):
	...
	lstm2 = Bidirectional(LSTM(300, activation='tanh', return_sequences=True, dropout=0.4))(inter)
	inter2 = Dropout(0.9)(lstm2)
	inter1 = TimeDistributed(Dense(500,activation='relu'))(inter2)
	inter = Dropout(0.9)(inter1)
	output = TimeDistributed(Dense(2,activation='softmax'))(inter)
