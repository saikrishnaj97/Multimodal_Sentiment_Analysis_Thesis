...
def Bimodal():
    ...
    lstm = Bidirectional(LSTM(600, activation='tanh', return_sequences=True, dropout=0.4, name='bi_lstm1'))(input_data)
    ...
    lstm = Bidirectional(LSTM(600, activation='tanh', return_sequences=True, dropout=0.4, name='bi_lstm2'))(input_data)
    ...
    lstm = Bidirectional(LSTM(600, activation='tanh', return_sequences=True, dropout=0.4, name='bi_lstm3'))(input_data)
...
def Trimodal():
    ...
    lstm = Bidirectional(LSTM(500, activation='tanh', return_sequences=True, dropout=0.35, name='tri_lstm'))(video_uttr)
